%from QPSK_W_fit_ver1
%sliding sample window, ber threshold in phase
%Wiener filter instead of uniform filter
%Wiener filter acts on signal^4 instead of angle(signal^4), then root M
%instead of divide M
numBits = 100000;
%additive noise
mu = 0;
...
legend('measured BER','Gaussian extrapolation','Analytical BER with phase noise','Analytical BER with no phase noise')