...
% poly33coeff = polyfit(thresh33,e33,1);
% poly33y = polyval(poly33coeff,log(linspace(0.1,1.9,37)));
% poly33y = exp(poly33y);
% plot(linspace(-0.9,0.9,37),poly33y)
